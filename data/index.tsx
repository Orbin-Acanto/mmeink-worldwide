  ...
  topRow: [
    {
      ...
      image: "/services/audio-visual/what-we-offer/gifs/offer-01.gif",
      width: "lg" as const,
    },
    {
      id: "2",
      title: "Stage Lighting",
      image: "/services/audio-visual/what-we-offer/images/offer-02.jpg",
      width: "md" as const,
    },
    {
      id: "3",
      title: "LED Video Walls",
      image: "/services/audio-visual/what-we-offer/images/offer-03.jpg",
      width: "xl" as const,
    },
    {
      id: "4",
      title: "Projection Mapping",
      image: "/services/audio-visual/what-we-offer/gifs/offer-04.gif",
      width: "sm" as const,
    },
    {
      id: "5",
      title: "Live Event Production",
      image: "/services/audio-visual/what-we-offer/images/offer-05.jpg",
      width: "lg" as const,
    },
    {
      id: "6",
      title: "Concert Sound",
      image: "/services/audio-visual/what-we-offer/gifs/offer-06.gif",
      width: "md" as const,
    },
  ],
  bottomRow: [
    {
      ...
      image: "/services/audio-visual/what-we-offer/gifs/offer-07.gif",
      width: "md" as const,
    },
    {
      id: "8",
      title: "Wireless Microphones",
      image: "/services/audio-visual/what-we-offer/images/offer-08.jpg",
      width: "sm" as const,
    },
    {
      id: "9",
      title: "DJ Equipment",
      image: "/services/audio-visual/what-we-offer/gifs/offer-09.gif",
      width: "lg" as const,
    },
    {
      id: "10",
      title: "Video Production",
      image: "/services/audio-visual/what-we-offer/images/offer-10.jpg",
      width: "xl" as const,
    },
    {
      id: "11",
      title: "Moving Head Lights",
      image: "/services/audio-visual/what-we-offer/gifs/offer-11.gif",
      width: "md" as const,
    },
    {
      id: "12",
      title: "Truss & Rigging",
      image: "/services/audio-visual/what-we-offer/images/offer-12.jpg",
      width: "lg" as const,
    },
  ],
};
...
export const CustomFabricationData = {
  title: "What We Offer",
  subtitle: "Custom built environments, fabricated and installed end to end",
  topRow: [
    {
      id: "1",
      title: "Custom Wood Work and Finishing",
      image: "/services/custom-fabrication/what-we-offer/gifs/wood-work.webp",
      width: "lg" as const,
    },
    {
      id: "2",
      title: "Themed Scenic Backdrops",
      image: "/services/custom-fabrication/what-we-offer/images/gallery-17.jpg",
      width: "md" as const,
    },
    {
      id: "3",
      title: "Stage and Set Installation",
      image: "/services/custom-fabrication/what-we-offer/gifs/stage.webp",
      width: "xl" as const,
    },
    {
      id: "4",
    ...
    {
      id: "5",
      title: "Large Format Art Walls",
      image: "/services/custom-fabrication/what-we-offer/images/gallery-09.jpg",
      width: "lg" as const,
    },
    {
      id: "6",
      title: "Dimensional Letter Fabrication",
      image: "/services/custom-fabrication/what-we-offer/gifs/ausa.webp",
      width: "md" as const,
    },
  ],
  bottomRow: [
    ...
    {
      id: "8",
      title: "Custom Set Builds",
      image: "/services/custom-fabrication/what-we-offer/images/gallery-21.jpg",
      width: "sm" as const,
    },
    {
      id: "9",
    ...
    },
    {
      ...
      image: "/services/custom-fabrication/what-we-offer/images/gallery-24.jpg",
      width: "md" as const,
    },
    {
      id: "12",
...
export const CustomFabricationImageGallery: GalleryImage[] = [
  {
    ...
    alt: "Mezcal Union custom wood bar wall with dimensional red lettering and vinyl record display",
  },
  {
    id: "2",
    src: "/services/custom-fabrication/gallery/gallery-02.jpg",
    alt: "Music City themed hospitality booth with custom facade, framed guitars, and marquee bar sign",
  },
  {
    id: "3",
    src: "/services/custom-fabrication/gallery/gallery-03.jpg",
    alt: "Custom die cut mixologist signage and white bar counter with gold geometric base",
  },
  {
    id: "4",
    src: "/services/custom-fabrication/gallery/gallery-04.jpg",
    alt: "Barneys New York garden activation with custom hedge archway and sculptural mannequin",
  },
  {
    id: "5",
    src: "/services/custom-fabrication/gallery/gallery-05.jpg",
    alt: "Custom arched stage backdrop panels with world map graphics and lounge seating",
  },
  {
    id: "6",
    src: "/services/custom-fabrication/gallery/gallery-06.jpg",
    alt: "Champagne wall with custom greenery panels, glassware shelving, and neon Cheers sign",
  },
  {
    id: "7",
    src: "/services/custom-fabrication/gallery/gallery-07.jpg",
    alt: "Rum Bar facade with illuminated marquee lettering on reclaimed wood arch",
  },
  {
    id: "8",
    src: "/services/custom-fabrication/gallery/gallery-08.jpg",
    alt: "Spotify Fit Check activation with LED lit mirror fitting stations and branded platform",
  },
  {
    id: "9",
    src: "/services/custom-fabrication/gallery/gallery-09.jpg",
    alt: "AICGS awards dinner with large scale custom art mural wall and illuminated base",
  },
  {
    id: "10",
    src: "/services/custom-fabrication/gallery/gallery-10.jpg",
    alt: "Gala stage design with oversized illuminated head sculptures and banquet seating",
  },
  {
    id: "11",
    src: "/services/custom-fabrication/gallery/gallery-11.jpg",
    alt: "Tented 50th celebration with floral number wall, disco balls, and custom cocktail tables",
  },
  {
    id: "12",
    src: "/services/custom-fabrication/gallery/gallery-12.jpg",
    alt: "Banana Republic and Magnolia Bakery custom green kiosk with scalloped awning and dessert display",
  },
  {
    id: "13",
    src: "/services/custom-fabrication/gallery/gallery-13.jpg",
    alt: "National Share Food Share Love trade show booth with custom shelving and seating area",
  },
  {
    id: "14",
    src: "/services/custom-fabrication/gallery/gallery-14.jpg",
    alt: "Philadelphia basketball themed photo backdrop wall with custom graphics and event lighting",
  },
  {
    id: "15",
    src: "/services/custom-fabrication/gallery/gallery-15.jpg",
    alt: "Immersive light tunnel installation with colorful strip lighting, arches, and palm trees",
  },
  {
    id: "16",
    src: "/services/custom-fabrication/gallery/gallery-16.jpg",
    alt: "The Estee Edit beauty kiosk with illuminated graphic panels and custom product display",
  },
  {
    id: "17",
    src: "/services/custom-fabrication/gallery/gallery-17.jpg",
    alt: "Havana Nights tropical scenic backdrop with custom lettering and layered foliage",
  },
  {
    id: "18",
    src: "/services/custom-fabrication/gallery/gallery-18.jpg",
    alt: "Wimbledon and Barclays branded vending cart with custom umbrella on turf activation",
  },
  {
    id: "19",
    src: "/services/custom-fabrication/gallery/gallery-19.jpg",
    alt: "Volkswagen street activation with custom market stall kiosk and vehicle display platform",
  },
  {
    id: "20",
    src: "/services/custom-fabrication/gallery/gallery-20.jpg",
    alt: "Mezcal Union mobile reclaimed wood bar with dimensional red lettering for outdoor events",
  },
  {
    id: "21",
    src: "/services/custom-fabrication/gallery/gallery-21.jpg",
    alt: "Indoor set build with custom cabin facade, teepee, campfire, and landscaped turf",
  },
  {
    id: "22",
    src: "/services/custom-fabrication/gallery/gallery-22.jpg",
    alt: "Camus cognac bar display with custom branded signage and luxury barware",
  },
  {
    id: "23",
    src: "/services/custom-fabrication/gallery/gallery-23.jpg",
    alt: "Marie Claire MC30 red kiosk in the fabrication shop before brand activation",
  },
  {
    id: "24",
    src: "/services/custom-fabrication/gallery/gallery-24.jpg",
    alt: "Womenterprise Summit stage set with custom arched backdrop panels and lounge seating",
  },
  {
    id: "25",
    src: "/services/custom-fabrication/gallery/gallery-25.jpg",
    alt: "Persol waterfront kiosk with custom directional signpost and display shelving",
  },
  {
    id: "26",
    src: "/services/custom-fabrication/gallery/gallery-26.jpg",
  ...
  },
  {
    ...
    alt: "Suspended sneaker display installation on acrylic shelves with truss structure",
  },
  {
    id: "28",
    src: "/services/custom-fabrication/gallery/gallery-28.jpg",
    alt: "ASICS product launch stage with custom truss platform and branded graphic panels",
  },
  {
    id: "29",
    src: "/services/custom-fabrication/gallery/gallery-29.jpg",
    alt: "Macy’s Tommy Girl retail pop up fitting room structures with custom branding",
  },
  {
    id: "30",
    src: "/services/custom-fabrication/gallery/gallery-30.jpg",
    alt: "Skullcandy tunnel entrance installation with illuminated light rays and check in kiosk",
  },
];
  ...
  topRow: [
    {
      id: "1",
      title: "Professional Sound Systems",
      image: "/services/rentals/what-we-offer/gifs/offer-01.gif",
      width: "lg" as const,
    },
    {
      id: "2",
      title: "Stage Lighting",
      image: "/services/rentals/what-we-offer/images/offer-02.jpg",
      width: "md" as const,
    },
    {
      id: "3",
      title: "LED Video Walls",
      image: "/services/rentals/what-we-offer/images/offer-03.jpg",
      width: "xl" as const,
    },
    {
      id: "4",
      title: "Projection Mapping",
      image: "/services/rentals/what-we-offer/gifs/offer-04.gif",
      width: "sm" as const,
    },
    {
      id: "5",
      title: "Live Event Production",
      image: "/services/rentals/what-we-offer/images/offer-05.jpg",
      width: "lg" as const,
    },
    {
      id: "6",
      title: "Concert Sound",
      image: "/services/rentals/what-we-offer/gifs/offer-06.gif",
      width: "md" as const,
    },
  ],
  bottomRow: [
    {
      id: "7",
      title: "Live Streaming",
      image: "/services/rentals/what-we-offer/gifs/offer-07.gif",
      width: "md" as const,
    },
    {
      id: "8",
      title: "Wireless Microphones",
      image: "/services/rentals/what-we-offer/images/offer-08.jpg",
      width: "sm" as const,
    },
    {
      id: "9",
      title: "DJ Equipment",
      image: "/services/rentals/what-we-offer/gifs/offer-09.gif",
      width: "lg" as const,
    },
    {
      id: "10",
      title: "Video Production",
      image: "/services/rentals/what-we-offer/images/offer-10.jpg",
      width: "xl" as const,
    },
    {
      id: "11",
      title: "Moving Head Lights",
      image: "/services/rentals/what-we-offer/gifs/offer-11.gif",
      width: "md" as const,
    },
    {
      id: "12",
      title: "Truss & Rigging",
      image: "/services/rentals/what-we-offer/images/offer-12.jpg",
      width: "lg" as const,
    },
  ],
};
  ...
  topRow: [
    {
      id: "1",
      title: "Professional Sound Systems",
      image: "/services/design-decor/what-we-offer/gifs/offer-01.gif",
      width: "lg" as const,
    },
    {
      id: "2",
      title: "Stage Lighting",
      image: "/services/design-decor/what-we-offer/images/offer-02.jpg",
      width: "md" as const,
    },
    {
      id: "3",
      title: "LED Video Walls",
      image: "/services/design-decor/what-we-offer/images/offer-03.jpg",
      width: "xl" as const,
    },
    {
      id: "4",
      title: "Projection Mapping",
      image: "/services/design-decor/what-we-offer/gifs/offer-04.gif",
      width: "sm" as const,
    },
    {
      id: "5",
      title: "Live Event Production",
      image: "/services/design-decor/what-we-offer/images/offer-05.jpg",
      width: "lg" as const,
    },
    {
      id: "6",
      title: "Concert Sound",
      image: "/services/design-decor/what-we-offer/gifs/offer-06.gif",
      width: "md" as const,
    },
  ],
  bottomRow: [
    {
      id: "7",
      title: "Live Streaming",
      image: "/services/design-decor/what-we-offer/gifs/offer-07.gif",
      width: "md" as const,
    },
    {
      id: "8",
      title: "Wireless Microphones",
      image: "/services/design-decor/what-we-offer/images/offer-08.jpg",
      width: "sm" as const,
    },
    {
      id: "9",
      title: "DJ Equipment",
      image: "/services/design-decor/what-we-offer/gifs/offer-09.gif",
      width: "lg" as const,
    },
    {
      id: "10",
      title: "Video Production",
      image: "/services/design-decor/what-we-offer/images/offer-10.jpg",
      width: "xl" as const,
    },
    {
      id: "11",
      title: "Moving Head Lights",
      image: "/services/design-decor/what-we-offer/gifs/offer-11.gif",
      width: "md" as const,
    },
    {
      id: "12",
      title: "Truss & Rigging",
      image: "/services/design-decor/what-we-offer/images/offer-12.jpg",
      width: "lg" as const,
    },
  ],
};
  ...
  topRow: [
    {
      ...
      image: "/services/logistics/what-we-offer/images/offer-01.png",
      width: "lg" as const,
    },
    {
      id: "2",
      title: "Load In & Load Out Management",
      image: "/services/logistics/what-we-offer/images/offer-02.png",
      width: "md" as const,
    },
    {
      id: "3",
      title: "Event Staffing & Crew",
      image: "/services/logistics/what-we-offer/images/offer-03.png",
      width: "xl" as const,
    },
    {
      id: "4",
      title: "Transportation & Freight",
      image: "/services/logistics/what-we-offer/gifs/offer-04.gif",
      width: "sm" as const,
    },
    {
      id: "5",
      title: "Permitting & Compliance",
      image: "/services/logistics/what-we-offer/images/offer-05.png",
      width: "lg" as const,
    },
    {
      id: "6",
      title: "Vendor Management",
      image: "/services/logistics/what-we-offer/gifs/offer-06.gif",
      width: "md" as const,
    },
  ],
  bottomRow: [
    {
      ...
      image: "/services/logistics/what-we-offer/gifs/offer-07.gif",
      width: "md" as const,
    },
    {
      id: "8",
      title: "Timeline & Run of Show",
      image: "/services/logistics/what-we-offer/images/offer-08.png",
      width: "sm" as const,
    },
    {
      id: "9",
      title: "Warehouse & Storage",
      image: "/services/logistics/what-we-offer/gifs/offer-09.gif",
      width: "lg" as const,
    },
    {
      id: "10",
      title: "Budget & Cost Management",
      image: "/services/logistics/what-we-offer/images/offer-10.png",
      width: "xl" as const,
    },
    {
      id: "11",
      title: "Safety & Risk Planning",
      image: "/services/logistics/what-we-offer/gifs/offer-11.gif",
      width: "md" as const,
    },
    {
      id: "12",
      title: "Post Event Reporting",
      image: "/services/logistics/what-we-offer/images/offer-12.png",
      width: "lg" as const,
    },
  ],
};
  ...
  topRow: [
    {
      ...
      image: "/services/printing/what-we-offer/images/offer-01.png",
      width: "lg" as const,
    },
    {
      id: "2",
      title: "Vinyl & Wall Wraps",
      image: "/services/printing/what-we-offer/images/offer-02.png",
      width: "md" as const,
    },
    {
      id: "3",
      title: "Step & Repeat Backdrops",
      image: "/services/printing/what-we-offer/images/offer-03.png",
      width: "xl" as const,
    },
    {
      id: "4",
      title: "Banners & Signage",
      image: "/services/printing/what-we-offer/images/offer-04.png",
      width: "sm" as const,
    },
    {
      id: "5",
      title: "Floor & Window Graphics",
      image: "/services/printing/what-we-offer/images/offer-05.png",
      width: "lg" as const,
    },
    {
      id: "6",
      title: "Fabric & Tension Prints",
      image: "/services/printing/what-we-offer/images/offer-06.png",
      width: "md" as const,
    },
  ],
  bottomRow: [
    {
      ...
      image: "/services/printing/what-we-offer/images/offer-07.png",
      width: "lg" as const,
    },
    {
      id: "8",
      title: "Directional & Wayfinding",
      image: "/services/printing/what-we-offer/images/offer-08.png",
      width: "md" as const,
    },
    {
      id: "9",
      title: "Branded Environments",
      image: "/services/printing/what-we-offer/images/offer-09.png",
      width: "xl" as const,
    },
    {
      id: "10",
      title: "Trade Show Graphics",
      image: "/services/printing/what-we-offer/images/offer-10.png",
      width: "sm" as const,
    },
    {
      id: "11",
      title: "Menu & Table Print",
      image: "/services/printing/what-we-offer/images/offer-11.png",
      width: "lg" as const,
    },
    {
      id: "12",
      title: "On Demand Reprints",
      image: "/services/printing/what-we-offer/images/offer-12.png",
      width: "md" as const,
    },
  ],
};
...
export const PrintingImageGallery: GalleryImage[] = [
  {
    id: "1",
    src: "/services/printing/gallery/gallery-01.jpg",
    alt: "Rhum Barbancourt branded booth with printed tropical wall graphics and hedge display",
  },
  {
    id: "2",
    src: "/services/printing/gallery/gallery-02.jpg",
    alt: "Printed vertical event banners in a marble rotunda with green uplighting",
  },
  {
    id: "3",
    src: "/services/printing/gallery/gallery-03.jpg",
    alt: "Step and repeat backdrop with red carpet and stanchions for a premiere event",
  },
  {
    id: "4",
    src: "/services/printing/gallery/gallery-04.jpg",
    alt: "Printed window graphics for IBM Watson Financial Services at a conference",
  },
  {
    id: "5",
    src: "/services/printing/gallery/gallery-05.jpg",
    alt: "White Walker by Johnnie Walker window graphics with Game of Thrones artwork",
  },
  {
    id: "6",
    src: "/services/printing/gallery/gallery-06.jpg",
    alt: "Market Movers Investor Summit registration desk with printed panels and banners",
  },
  {
    id: "7",
    src: "/services/printing/gallery/gallery-07.jpg",
    alt: "OpenText Summit registration desk with printed facade panels and pull up banners",
  },
  {
    id: "8",
    src: "/services/printing/gallery/gallery-08.jpg",
    alt: "Large format printed mural wall for a Philadelphia youth basketball program",
  },
  {
    id: "9",
    src: "/services/printing/gallery/gallery-09.jpg",
    alt: "Rolling Rock printed column wrap at a stadium concourse activation",
  },
  {
    id: "10",
    src: "/services/printing/gallery/gallery-10.jpg",
    alt: "Sephora Next Big Thing retail display with printed counter graphics",
  },
  {
    id: "11",
    src: "/services/printing/gallery/gallery-11.jpg",
    alt: "KX branded step and repeat backdrop for a corporate press event",
  },
  {
    id: "12",
    src: "/services/printing/gallery/gallery-12.jpg",
    alt: "Illuminated sponsor wall with printed logos in a custom architectural frame",
  },
  {
    id: "13",
    src: "/services/printing/gallery/gallery-13.jpg",
    alt: "YSL Beauté printed brand wall with product display plinths",
  },
];
  ...
  topRow: [
    {
      ...
      image: "/services/lighting/what-we-offer/images/offer-01.png",
      width: "lg" as const,
    },
    {
      id: "2",
      title: "Intelligent & Moving Head",
      image: "/services/lighting/what-we-offer/images/offer-02.png",
      width: "md" as const,
    },
    {
      id: "3",
      title: "Architectural Uplighting",
      image: "/services/lighting/what-we-offer/images/offer-03.png",
      width: "xl" as const,
    },
    {
      id: "4",
      title: "Custom Gobo Projection",
      image: "/services/lighting/what-we-offer/images/offer-04.png",
      width: "sm" as const,
    },
    {
      id: "5",
      title: "Pin Spotting",
      image: "/services/lighting/what-we-offer/images/offer-05.png",
      width: "lg" as const,
    },
    {
      id: "6",
      title: "Ambient & Mood Washes",
      image: "/services/lighting/what-we-offer/images/offer-06.png",
      width: "md" as const,
    },
  ],
  bottomRow: [
    {
      ...
      image: "/services/lighting/what-we-offer/images/offer-07.png",
      width: "lg" as const,
    },
    {
      id: "8",
      title: "LED Colour Systems",
      image: "/services/lighting/what-we-offer/images/offer-08.png",
      width: "md" as const,
    },
    {
      id: "9",
      title: "Truss & Rigging",
      image: "/services/lighting/what-we-offer/images/offer-09.png",
      width: "xl" as const,
    },
    {
      id: "10",
      title: "Lighting Console Programming",
      image: "/services/lighting/what-we-offer/images/offer-10.png",
      width: "sm" as const,
    },
    {
      id: "11",
      title: "Power Distribution",
      image: "/services/lighting/what-we-offer/images/offer-11.png",
      width: "lg" as const,
    },
    {
      id: "12",
      title: "On Site Lighting Crew",
      image: "/services/lighting/what-we-offer/images/offer-12.png",
      width: "md" as const,
    },
  ],
};
  ...
  topRow: [
    {
      ...
      image: "/services/staging/what-we-offer/images/offer-01.png",
      width: "lg" as const,
    },
    {
      id: "2",
      title: "Modular Decking & Risers",
      image: "/services/staging/what-we-offer/images/offer-02.png",
      width: "md" as const,
    },
    {
      id: "3",
      title: "Runways & Catwalks",
      image: "/services/staging/what-we-offer/images/offer-03.png",
      width: "xl" as const,
    },
    {
      id: "4",
      title: "ADA Ramps & Access",
      image: "/services/staging/what-we-offer/images/offer-04.png",
      width: "sm" as const,
    },
    {
      id: "5",
      title: "Pipe & Drape",
      image: "/services/staging/what-we-offer/images/offer-05.png",
      width: "lg" as const,
    },
    {
      id: "6",
      title: "Scenic Backdrops",
      image: "/services/staging/what-we-offer/images/offer-06.png",
      width: "md" as const,
    },
  ],
  bottomRow: [
    {
      ...
      image: "/services/staging/what-we-offer/images/offer-07.png",
      width: "lg" as const,
    },
    {
      id: "8",
      title: "Stage Skirting & Finishes",
      image: "/services/staging/what-we-offer/images/offer-08.png",
      width: "md" as const,
    },
    {
      id: "9",
      title: "Podiums & Lecterns",
      image: "/services/staging/what-we-offer/images/offer-09.png",
      width: "xl" as const,
    },
    {
      id: "10",
      title: "Backline Platforms",
      image: "/services/staging/what-we-offer/images/offer-10.png",
      width: "sm" as const,
    },
    {
      id: "11",
      title: "Load Bearing Engineering",
      image: "/services/staging/what-we-offer/images/offer-11.png",
      width: "lg" as const,
    },
    {
      id: "12",
      title: "On Site Build Crew",
      image: "/services/staging/what-we-offer/images/offer-12.png",
      width: "md" as const,
    },
  ],
};
  ...
  topRow: [
    {
      ...
      image: "/services/themes/what-we-offer/images/offer-01.png",
      width: "lg" as const,
    },
    {
      id: "2",
      title: "Mood Boards & Renderings",
      image: "/services/themes/what-we-offer/images/offer-02.png",
      width: "md" as const,
    },
    {
      id: "3",
      title: "Themed Environments",
      image: "/services/themes/what-we-offer/images/offer-03.png",
      width: "xl" as const,
    },
    {
      id: "4",
      title: "Immersive Installations",
      image: "/services/themes/what-we-offer/images/offer-04.png",
      width: "sm" as const,
    },
    {
      id: "5",
      title: "Custom Scenic Design",
      image: "/services/themes/what-we-offer/images/offer-05.png",
      width: "lg" as const,
    },
    {
      id: "6",
      title: "Colour & Material Palettes",
      image: "/services/themes/what-we-offer/images/offer-06.png",
      width: "md" as const,
    },
  ],
  bottomRow: [
    {
      ...
      image: "/services/themes/what-we-offer/images/offer-07.png",
      width: "lg" as const,
    },
    {
      id: "8",
      title: "Photo Moments",
      image: "/services/themes/what-we-offer/images/offer-08.png",
      width: "md" as const,
    },
    {
      id: "9",
      title: "Seasonal Concepts",
      image: "/services/themes/what-we-offer/images/offer-09.png",
      width: "xl" as const,
    },
    {
      id: "10",
      title: "Cultural & Heritage Themes",
      image: "/services/themes/what-we-offer/images/offer-10.png",
      width: "sm" as const,
    },
    {
      id: "11",
      title: "Brand Led Concepts",
      image: "/services/themes/what-we-offer/images/offer-11.png",
      width: "lg" as const,
    },
    {
      id: "12",
      title: "Full Theme Execution",
      image: "/services/themes/what-we-offer/images/offer-12.png",
      width: "md" as const,
    },
  ],
};
  ...
  topRow: [
    {
      ...
      image: "/services/props/what-we-offer/images/offer-01.png",
      width: "lg" as const,
    },
    {
      id: "2",
      title: "Oversized Statement Pieces",
      image: "/services/props/what-we-offer/images/offer-02.png",
      width: "md" as const,
    },
    {
      id: "3",
      title: "Themed Prop Packages",
      image: "/services/props/what-we-offer/images/offer-03.png",
      width: "xl" as const,
    },
    {
      id: "4",
      title: "Photo Moment Props",
      image: "/services/props/what-we-offer/images/offer-04.png",
      width: "sm" as const,
    },
    {
      id: "5",
      title: "Branded Prop Builds",
      image: "/services/props/what-we-offer/images/offer-05.png",
      width: "lg" as const,
    },
    {
      id: "6",
      title: "Sculptural Elements",
      image: "/services/props/what-we-offer/images/offer-06.png",
      width: "md" as const,
    },
  ],
  bottomRow: [
    {
      ...
      image: "/services/props/what-we-offer/images/offer-07.png",
      width: "lg" as const,
    },
    {
      id: "8",
      title: "Seasonal Prop Inventory",
      image: "/services/props/what-we-offer/images/offer-08.png",
      width: "md" as const,
    },
    {
      id: "9",
      title: "Prop Refinishing",
      image: "/services/props/what-we-offer/images/offer-09.png",
      width: "xl" as const,
    },
    {
      id: "10",
      title: "Prop Sourcing",
      image: "/services/props/what-we-offer/images/offer-10.png",
      width: "sm" as const,
    },
    {
      id: "11",
      title: "Storage & Warehousing",
      image: "/services/props/what-we-offer/images/offer-11.png",
      width: "lg" as const,
    },
    {
      id: "12",
      title: "Delivery & Placement",
      image: "/services/props/what-we-offer/images/offer-12.png",
      width: "md" as const,
    },
  ],
};
