    ...
    images: [
      {
        ...
        alt: "Costumed dealer carrying a roving roulette table through black tie guests at a gala",
        client: "Casino Experiences",
        title: "Roving Roulette on the Floor",
      },
      {
        src: "/services/entertainment/featured/featured-02.jpg",
        alt: "Guest riding a surf simulator on an inflatable wave between palm trees at sunset",
        client: "Inflatable Experiences & Attractions",
        title: "Surf Simulator at Sunset",
      },
      {
        src: "/services/entertainment/featured/featured-03.jpg",
        alt: "Guests playing table tennis on a glowing blue table at a night time activation",
        client: "Sports & Competitive Experiences",
        title: "Glow Table Tennis After Dark",
      },
      {
        src: "/services/entertainment/featured/featured-04.jpg",
        alt: "Branded kiosk and green screen station set among planting in a courtyard activation",
        client: "Photo Activations & Immersive Content Experiences",
        title: "Courtyard Capture Station",
      },
      {
        src: "/services/entertainment/featured/featured-05.jpg",
        alt: "Illuminated digital display tower running brand content in a retail concourse",
        client: "Digital Engagement & Interactive Technology",
        title: "Digital Tower in the Concourse",
      },
      {
        src: "/services/entertainment/featured/featured-06.jpg",
        alt: "Green screen studio rigged with lighting and cameras for on site content capture",
        client: "Photo Activations & Immersive Content Experiences",
        title: "On Site Content Studio",
      },
    ],
  },
  lighting: {
