...
export default function EventDetailsSection({
  ...
  return (
    <section className="w-full py-16 sm:py-20 lg:py-24 bg-gray-200">
      <div className="mb-6 px-4 text-center sm:mb-10 sm:px-6 md:mb-14">
        <h2 className="mb-2 uppercase text-2xl font-bold tracking-tight text-neutral-900 dark:text-neutral-100 sm:mb-3 sm:text-4xl md:text-5xl lg:text-6xl">
          {title}
        </h2>
      ...
      <div className="grid w-full grid-cols-1 gap-0 sm:grid-cols-[64px_1fr] md:grid-cols-[80px_1fr]">
        <div className="relative hidden sm:block">
          <div className="sticky top-10 flex h-[60vh] items-center justify-center sm:h-[25vh] md:h-[40vh] lg:h-[55vh] xl:h-[65vh]">
            <div
              className="select-none text-base font-bold tracking-[0.2em] text-neutral-500 dark:text-neutral-400"
              style={{
