...
export default function OurTeamSection() {
  // Denise leads on her own row; everyone else fills the three column grid
  // below her, which comes out to two even rows of three.
  ...
  return (
    <section className="relative w-full py-20 bg-white overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* max-w-sm lands within a pixel or two of one column of the grid
            below, so the lead card reads as part of the same system. */}
        {lead && (
          <div className="mx-auto w-full max-w-sm mb-8 lg:mb-10">
            <TeamCard member={lead} delay={0} />
          </div>
        )}
